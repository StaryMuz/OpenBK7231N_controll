...
Poslední aktualizace projektu 7.8.2026 (snížena průběžná zátěž CPU serveru běžícím skryptem a zajištěn chod v přesných časech bez časových skluzů cron).
...
Last project update: August 7, 2026 (reduced the ongoing CPU load on the server caused by the running script and ensured operation at precise times without cron time slippage).
